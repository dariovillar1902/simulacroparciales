...
export const Puertos1PScreen = () => {
  ...
  const correctasPorUnidad = useRef([0, 0, 0, 0, 0, 0, 0, 0]);
  ...
  const reset = () => {
    ...
    correctasPorUnidad.current = [0, 0, 0, 0, 0, 0, 0, 0];
    incorrectasPorUnidad.current = [0, 0, 0, 0, 0, 0, 0, 0];
  ...
  useEffect(() => {
    ...
    if (unidades) {
      ...
      setUnidades([1, 2, 3, 4, 5, 6, 7, 8]);
      checkUnidades([1, 2, 3, 4, 5, 6, 7, 8]);
    }
