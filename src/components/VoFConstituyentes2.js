...
import bancoPreguntas2 from '../data/bancoPreguntas2.json'
import Swal from 'sweetalert2';
import "../styles/styles.scss";

export const VoFConstituyentes2 = () => {
    ...
    const seleccionPregunta = useCallback(
        () => {
            let filtroConstituyentes = bancoPreguntas2.filter(pregunta => pregunta.unidad === 'Materiales Constituyentes');
